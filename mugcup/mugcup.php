				...
				<div class="row my-row alert alert-secondary">
					<div class="col-md-6 col-sm-6 my-col">
						<div class="img" style="text-align: center">
							<img src="img/mugmain.png" alt="mugcup" width="300" height="300">
						</div>
					</div>
					<div class="col-md-6 col-sm-6 my-col">
						<div class="info" style="text-align: right">
							<h2 class="prdname" style="margin-top: 30px">백자 무지 머그컵</h2>
...
<!------------------------------------------detail------------------------------------------>
			<div class="container detail alert alert-secondary" style="text-align: center;  width: 780px">
				...
				<img src="img/mugdetail.png" width="700" alt="mugcupdetail">
			</div>
<!------------------------------------------other product------------------------------------------>
			<div class="container alert alert-secondary" style="text-align: center">
				...
				<div class="row my-row">
						<div class="col-md-2 col-sm-2 my-col">
							<a href="../case/case.php"><img src="../case/img/casemain.png" width="180" height="180" alt="case"></a>
						</div>
						<div class="col-md-2 col-sm-2 my-col">
