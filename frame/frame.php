				...
				<div class="row my-row alert alert-secondary">
					<div class="col-md-6 col-sm-6 my-col">
						<div class="img" style="text-align: center">
							<img src="img/framemain.png" alt="framemain" width="300" height="300">
						</div>
					</div>
					<div class="col-md-6 col-sm-6 my-col">
						<div class="info" style="text-align: right">
							<h2 class="prdname" style="margin-top: 30px">액자</h2>
...
<!------------------------------------------detail------------------------------------------>
			<div class="container detail alert alert-secondary" style="text-align: center;  width: 780px">
				...
				<img src="img/framedetail.png" width="700" alt="framedetail">
			</div>
<!------------------------------------------other product------------------------------------------>
